...
of what's possible on the web.`,
  ...
  isLive: false,
},
    {
      title: "ImageGallery",
      description:
        "A full-stack image gallery application featuring secure user authentication, cloud-based media storage via Cloudinary, and intuitive album organization with custom tagging. Users can upload, manage, and browse images through a fully responsive UI built with Tailwind CSS, with role-based access ensuring each user's media remains private and protected.",
      tech: [
        "React",
        "Node.js",
        "Express",
    ...
    },
    {
      ...
      githubUrl: "https://github.com/kushshah1554/Todo-App",
      year: "2024",
      isLive: true,
    },
    {
      ...
      githubUrl: "https://github.com/kushshah1554/WorkConnect",
      year: "2024",
      isLive: true,
    },
  ],
...
function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const grow = () =>
      gsap.to(ring.current, { scale: 2.8, opacity: 0.35, duration: 0.25 });
    const shrink = () =>
  ...
  return (
    <>
      <div
        ref={dot}
        className="fixed z-9999 pointer-events-none top-0 left-0 w-2 h-2 rounded-full bg-[#00e5a0]"
        style={{
      ...
      <div
        ref={ring}
        className="fixed z-9998 pointer-events-none top-0 left-0 w-8 h-8 rounded-full border border-[#00e5a0]"
...
export default function Portfolio() {
  ...
  useEffect(() => {
    ...
    link.rel = "stylesheet";
    link.href =
      "https://fonts.googleapis.com/css2?family=Bebas+Neue&family=DM+Sans:ital,wght@0,300;0,400;0,500;0,600;1,300&family=JetBrains+Mono:wght@400;500;600&display=swap";
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.from(".hero-eyebrow", { opacity: 0, y: 24, duration: 0.55 })
        ...
        .from(
          ".hero-role",
          { opacity: 0, x: -36, duration: 0.6, ease: "power3.out" },
          "-=0.5",
        )
        .from(".hero-tagline", { opacity: 0, y: 20, duration: 0.5 }, "-=0.35")
        .from(
          ".hero-cta > *",
          { opacity: 0, y: 22, stagger: 0.1, duration: 0.5 },
          "-=0.3",
        )
        .from(
          ".hero-stats > *",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormStatus({
        type: "err",
        msg: "Couldn't send. Try emailing directly.",
      });
    }
  ...
  return (
    <div className="min-h-screen bg-[#08090c] text-[#f0eff8] overflow-x-hidden relative">
      ...
      >
        {/* Background orbs */}
        <div
          className="orb-1 absolute top-[22%] right-[20%] w-[380px] h-[380px] rounded-full pointer-events-none blur-[80px] opacity-[0.12]"
          style={{
            background: "radial-gradient(circle, #00e5a0, transparent 65%)",
          }}
        />
        <div
          className="orb-2 absolute bottom-[25%] left-[8%] w-[460px] h-[460px] rounded-full pointer-events-none blur-[90px] opacity-[0.08]"
          style={{
            background: "radial-gradient(circle, #4f46e5, transparent 65%)",
          }}
        />
        <div
          className="orb-3 absolute top-[55%] left-[45%] w-[300px] h-[300px] rounded-full pointer-events-none blur-[70px] opacity-[0.07]"
          style={{
            background: "radial-gradient(circle, #e5006c, transparent 65%)",
          }}
        />
        ...
        <div className="relative z-10 max-w-5xl">
          ...
          <h1
            className="display-font leading-none text-white mb-5"
          ...
          <p
            className="hero-role display-font text-[#00e5a0] mb-4"
          ...
          <div className="hero-stats flex flex-wrap gap-10">
            {PORTFOLIO.stats.map((s) => (
              <div key={s.label}>
                <div className="display-font text-[2.8rem] text-white leading-none">
                  {s.value}
                </div>
                <div className="mono-font text-[10px] text-[#6b7280] uppercase tracking-widest mt-1">
                  {s.label}
                </div>
              </div>
            ))}
        ...
        <div className="hero-scroll absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
          <span className="mono-font text-[#4b5563] text-[10px] uppercase tracking-[0.25em]">
            Scroll
          </span>
      ...
      >
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="about-text space-y-6">
            ...
            <p className="text-[#6b7280] leading-[1.85] whitespace-pre-line">
              {PORTFOLIO.about}
            </p>
            ...
            <div className="grid grid-cols-3 gap-3 pt-2">
              {PORTFOLIO.stats.map((s) => (
                ...
                >
                  <span className="display-font text-[2.2rem] text-[#00e5a0] leading-none">
                    {s.value}
                  </span>
                  <span className="mono-font text-[9px] text-[#6b7280] uppercase tracking-widest mt-1 text-center">
                    {s.label}
                  </span>
                </div>
              ))}
          ...
          <div className="relative flex items-center justify-center py-8">
            {/* Outer glow */}
            <div
              className="absolute w-[300px] h-[380px] rounded-[28px] blur-[60px] opacity-[0.18]"
              style={{
            ...
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 0 0 1px rgba(0,229,160,0.12), 0 32px 64px rgba(0,0,0,0.6)",
              }}
            >
              <img
                src={PHOTO_URL}
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to right, transparent, rgba(0,229,160,0.5), transparent)",
                  top: "-4px",
                }}
              />
            </div>
            ...
            >
              <div className="mono-font text-[9px] text-[#4b5563] uppercase tracking-widest mb-1">
                Status
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="mono-font text-[11px] text-[#00e5a0] font-semibold">
                  Available for work
                </span>
              </div>
            </div>
            ...
            >
              <span className="mono-font text-[10px] text-[#00e5a0]">
                Full-Stack Dev
              </span>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              {[
                ...
                >
                  ...
                  <div className="min-w-0">
                    <div className="mono-font text-[10px] text-[#4b5563] uppercase tracking-widest">
                      {label}
                    </div>
                    <div className="text-sm text-white group-hover:text-[#00e5a0] transition-colors truncate">
                      {value}
                    </div>
                  </div>
            ...
            <form className="contact-form space-y-4" onSubmit={handleSubmit}>
              ...
              {formStatus.msg && (
                <p
                  className={`mono-font text-sm text-center ${
                    formStatus.type === "ok"
                      ? "text-[#00e5a0]"
                      : "text-[#ff5757]"
                  }`}
